...
const emits = defineEmits(['closefinance'])
const closeDialog = () => {
    emits('closefinance', false)
}
...
<template>
  ...
  <!-- 采用对话框，允许拖拽 -->
  <el-dialog v-model="dialog" width="1200" title="财务信息变更" draggable @close="closeDialog">

    <!-- 填写部分 -->
    <div class="basic_information_phyinf">
        <!-- 变更单号 -->
        <div class="block">
            <span class="demonstration">变更单号</span>
    ...
    <div class="change_content_box_2">
        <!-- 所属公司变更为 -->
        <div class="block">
         <span class="demonstration">所属公司变更为</span>
         <el-select v-model="value" class="m-2" placeholder="Select">
            <el-option
            v-for="item in options"
            :key="item.value"
        ...
        <!-- 金额变更为 -->
        <div class="block">
        <span class="demonstration">金额变更为</span>
         <el-input style="height:40px ;width: 400px;" placeholder="Please input" />
            ...
            <div class="block" style="width: 1100px;">
             <span class="demonstration">变更说明</span>
             <el-input 
             v-model="textarea"
             :rows="3"
             type="textarea"
