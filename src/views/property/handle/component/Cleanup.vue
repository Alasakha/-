...
const emits = defineEmits(['closecleanup'])
const closeDialog = () => {
    emits('closecleanup', false)
}
...
<template>
  ...
  <el-dialog v-model="dialog" width="1200" title="清理报废" draggable @close="closeDialog">
    ...
    <div class="basic_information_phyinf">
        <!-- 清理单号 -->
        <div class="block">
            <span class="demonstration">清理单号</span>
        ...
        <el-date-picker
         ...
         <!-- 清理处理人 -->
         <div class="block">
            <span class="demonstration">清理处理人</span>
            <el-input v-model="input" disabled placeholder="李白" />
         </div>
      </div>

    <div class="basic_information_title"> 清理信息</div>
         
    <div class="change_content_box_2">
          <!-- 清理原因 -->
        <div class="block" style="width: 1100px;">
             <span class="demonstration">清理原因</span>
             <el-input 
              v-model="textarea"
             :rows="3"
             type="textarea"
         ...
         <div v-for="fit in fits" :key="fit" class="block">
            ...
            <el-image style="width: 100px; height: 100px" :src="url" :fit="fit" />
                   ...
                   <el-table
                    ...
                    <el-table-column prop="assetclass" label="规格型号" width="150"  />
                    <el-table-column prop="assetclass" label="购入日期" width="150" />
                    <el-table-column prop="assetclass" label="所属公司" width="150" />
                    <el-table-column prop="assetclass" label="当前所在公司" width="170" />                    
                    <el-table-column prop="assetclass" label="当前所在部门" width="170" />                    
                    <el-table-column prop="assetclass" label="当前使用人" width="170" />                   
                    <el-table-column prop="assetclass" label="存放地点" width="170" />                  
                </el-table>
             <!-- 底部添加框和重置框 -->
        <el-form-item>
