...
const emits = defineEmits(['closeborrow'])
const closeDialog = () => {
...
<template>
  ...
  <!-- 采用对话框，允许拖拽 -->
  <el-dialog v-model="dialog" width="1200" title="新建信用单" draggable @close="closeDialog"
  >
    ...
    <div class="basic_information_borrow">
        <!-- 借用人 -->
        <div class="block">
         <span class="demonstration">借用人</span>
        ...
        <!-- 借出日期 -->
        <div class="block">
         <span class="demonstration">借出日期</span>
         <el-date-picker
            v-model="value1"
            type="date"
        ...
        <!-- 实际归还时间 -->
        <div class="block">
            <span class="demonstration">实际归还时间</span>
            <el-input v-model="input" disabled placeholder="Please input" />
         </div>

         <!-- 归还处理人 -->
         <div class="block">
            <span class="demonstration">归还处理人</span>
            <el-input v-model="input" disabled placeholder="Please input" />
         </div>
                ...
                <span class="demonstration">借出处理人</span>
                 <el-input v-model="input" disabled placeholder="Please input" />
                   ...
                   <el-table
                    ...
                    <el-table-column prop="assetclass" label="当前所在公司" width="130" />
                    <el-table-column prop="assetclass" label="当前所在部门" width="120" />
